...
document.addEventListener('DOMContentLoaded', function() {
  if (typeof THREE === 'undefined') {
    ...
    if (viewerCanvas) {
      viewerCanvas.innerHTML = '<div style="color:red;font-size:18px;padding:20px;">Three.js is not loaded!<br>Check your script order and CDN loading.</div>';
    }
    return;
  }
  ...
  if (typeof window.OrbitControls === 'function') {
    ...
    if (viewerCanvas) {
      viewerCanvas.innerHTML = '<div style="color:red;font-size:18px;padding:20px;">OrbitControls is not available!<br>Check your script order and CDN loading.</div>';
    }
  ...
  function initViewer() {
    ...
    if (typeof window.GLTFLoader === 'function') {
      ...
      if (viewerCanvas) {
        viewerCanvas.innerHTML = '<div style="color:red;font-size:18px;padding:20px;">GLTFLoader is not available!<br>Check your script order and CDN loading.</div>';
      }
