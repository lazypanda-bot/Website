...
if ($action === 'list') {
    ...
    // Use snake_case DB columns and alias to legacy keys
    $sql = "SELECT o.order_id, o.customer_id, o.total_amount AS TotalAmount, o.partial_payment AS isPartialPayment, o.order_status AS OrderStatus, o.created_at,
